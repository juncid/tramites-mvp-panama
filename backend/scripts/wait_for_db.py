...
DB_NAME = os.getenv('DATABASE_NAME', 'SIM_PANAMA')
...
def wait_for_database(max_attempts: int = 30, delay: int = 3) -> bool:
    ...
    print(f"🔍 Verificando disponibilidad de la base de datos {DB_NAME}...")
    ...
    for attempt in range(1, max_attempts + 1):
        try:
            ...
            print(f"✅ Base de datos {DB_NAME} está completamente operativa")
            return True
...
def verify_base_tables() -> bool:
    ...
    required_tables = [
        ...
        'SIM_GE_PAIS',
        'SIM_GE_AGENCIA',
        'SIM_FT_TRAMITES',  # Actualizado a la nueva estructura SIM_FT_*
        'SEG_TB_ROLES'
    ]
