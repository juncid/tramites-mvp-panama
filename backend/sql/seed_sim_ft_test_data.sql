...
BEGIN
    INSERT INTO SIM_FT_TRAMITE_D (NUM_ANNIO, NUM_TRAMITE, NUM_REGISTRO, NUM_PASO, IND_ESTATUS, OBS_OBSERVA, IND_ACTIVO, ID_USUARIO_CREA, FEC_ACTUALIZA)
    VALUES (2025, 5001, 1, 1, '01', 'Solicitud recibida - Documentos completos', 'S', 'TEST_USER', DATEADD(DAY, -5, GETDATE()));
    
    INSERT INTO SIM_FT_TRAMITE_D (NUM_ANNIO, NUM_TRAMITE, NUM_REGISTRO, NUM_PASO, IND_ESTATUS, OBS_OBSERVA, IND_ACTIVO, ID_USUARIO_CREA, FEC_ACTUALIZA)
    VALUES (2025, 5001, 1, 2, '02', 'Verificación en proceso', 'S', 'ADMIN', DATEADD(DAY, -3, GETDATE()));
...
BEGIN
    INSERT INTO SIM_FT_TRAMITE_D (NUM_ANNIO, NUM_TRAMITE, NUM_REGISTRO, NUM_PASO, IND_ESTATUS, OBS_OBSERVA, IND_ACTIVO, ID_USUARIO_CREA, FEC_ACTUALIZA)
    VALUES 
        (2025, 5002, 1, 1, '01', 'Recepción OK', 'S', 'ADMIN', DATEADD(DAY, -10, GETDATE())),
        (2025, 5002, 1, 2, '02', 'Documentos verificados', 'S', 'ADMIN', DATEADD(DAY, -8, GETDATE())),
        (2025, 5002, 1, 3, '02', 'Evaluación legal completada', 'S', 'ADMIN', DATEADD(DAY, -5, GETDATE())),
        (2025, 5002, 1, 4, '04', 'Esperando aprobación directiva', 'S', 'ADMIN', DATEADD(DAY, -2, GETDATE()));
...
BEGIN
    INSERT INTO SIM_FT_TRAMITE_D (NUM_ANNIO, NUM_TRAMITE, NUM_REGISTRO, NUM_PASO, IND_ESTATUS, OBS_OBSERVA, IND_ACTIVO, ID_USUARIO_CREA, FEC_ACTUALIZA)
    VALUES 
        (2025, 5003, 1, 1, '01', 'Recepción', 'S', 'ADMIN', DATEADD(DAY, -20, GETDATE())),
        (2025, 5003, 1, 2, '02', 'Verificación OK', 'S', 'ADMIN', DATEADD(DAY, -18, GETDATE())),
        (2025, 5003, 1, 3, '02', 'Evaluación legal OK', 'S', 'ADMIN', DATEADD(DAY, -15, GETDATE())),
        (2025, 5003, 1, 4, '05', 'Aprobado por director', 'S', 'ADMIN', DATEADD(DAY, -10, GETDATE())),
        (2025, 5003, 1, 5, '08', 'Pago verificado', 'S', 'ADMIN', DATEADD(DAY, -5, GETDATE())),
        (2025, 5003, 1, 6, '10', 'Permiso emitido', 'S', 'ADMIN', DATEADD(DAY, -1, GETDATE()));
