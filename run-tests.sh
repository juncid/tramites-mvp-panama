...
run_integration_tests() {
    ...
    docker-compose -f docker-compose.test.yml up --build --abort-on-container-exit test-integration
    local exit_code=$?
...
trap 'echo -e "\n${YELLOW}Interrumpido por usuario${NC}"; docker-compose -f docker-compose.test.yml down' INT TERM
