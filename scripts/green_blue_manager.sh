...
deploy_green_blue() {
    ...
    docker-compose -f config/docker-compose.green-blue.yml up -d sqlserver-green redis-green backend-green
    ...
    docker-compose -f config/docker-compose.green-blue.yml up -d sqlserver-blue redis-blue backend-blue
    ...
    docker-compose -f config/docker-compose.green-blue.yml run --rm migration-service
    ...
    docker-compose -f config/docker-compose.green-blue.yml up -d nginx-proxy
...
stop_green() {
    ...
    echo
    if [[ $REPLY =~ ^[Yy]$ ]]; then
        docker-compose -f config/docker-compose.green-blue.yml stop backend-green sqlserver-green redis-green
...
stop_blue() {
    ...
    echo
    if [[ $REPLY =~ ^[Yy]$ ]]; then
        docker-compose -f config/docker-compose.green-blue.yml stop backend-blue sqlserver-blue redis-blue
...
cleanup() {
    ...
    echo
    if [[ $REPLY =~ ^[Yy]$ ]]; then
        docker-compose -f config/docker-compose.green-blue.yml down --volumes --remove-orphans
