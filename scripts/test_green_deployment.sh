...
docker-compose -f config/docker-compose.dev.yml down --remove-orphans 2>/dev/null || true

echo ""
echo "🟢 Iniciando solo ambiente GREEN para prueba..."

# Levantar solo GREEN primero
docker-compose -f config/docker-compose.green-blue.yml up -d sqlserver-green redis-green
